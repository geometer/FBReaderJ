...
public class ZLBooleanOptionTests2 extends TestCase {
	
	private ZLConfig myConfig = ZLConfigInstance.getInstance();
	
	private void runTask2a(String configValue, boolean value2, 
			boolean value3, boolean expectedValue) {
		myConfig.setValue("boolean_group_2", "name", configValue, "boolean_category");
	...
	private void runTask2b(String configValue, boolean value2, 
			boolean value3, String expectedValue) {
		myConfig.setValue("boolean_group_2", "name", configValue, "boolean_category");
		ZLBooleanOption option = new ZLBooleanOption("boolean_category", 
				"boolean_group_2", "name", value2);
		option.setValue(value3);
		assertEquals(myConfig.getValue("boolean_group_2", "name", "def"), expectedValue);
	}
	
	public void tearDown() {
		myConfig.unsetValue("boolean_group_2", "name");
	}
