...
public class ZLStringOptionTests2 extends TestCase {
	...
	private void runTask2a(String configValue, String value2, 
			String value3, String expectedValue) {
		myConfig.setValue("string_group_2", "name", configValue, "string_category");
	...
	private void runTask2b(String configValue, String value2, 
			String value3, String expectedValue) {
		myConfig.setValue("string_group_2", "name", configValue, "string_category");
		ZLStringOption option = new ZLStringOption("string_category", 
				"string_group_2", "name", value2);
		option.setValue(value3);
		assertEquals(myConfig.getValue("string_group_2", "name", "def"), expectedValue);
	}
