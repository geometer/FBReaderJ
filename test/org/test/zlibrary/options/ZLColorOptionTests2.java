...
public class ZLColorOptionTests2 extends TestCase {
	...
	private void runTask2a(String configValue, ZLColor value2, 
			ZLColor value3, int expectedValue) {
		myConfig.setValue("color_group_2", "name", configValue, "color_category");
	...
	private void runTask2b(String configValue, ZLColor value2, 
			ZLColor value3, String expectedValue) {
		myConfig.setValue("color_group_2", "name", configValue, "color_category");
		ZLColorOption option = new ZLColorOption("color_category", 
				"color_group_2", "name", value2);
		option.setValue(value3);
		assertEquals(myConfig.getValue("color_group_2", "name", "def"), expectedValue);
	}
	...
	public void test2a_4_09() {
		runTask2a("12323412", new ZLColor(11599619), new ZLColor(11599620), 11599620);
	}
	
	public void test2a_4_10() {
		runTask2a("12323412", new ZLColor(11599619), new ZLColor(11599619), 11599619);
	}
	...
	public void test2a_5_03() {
		runTask2a("1232342351263423745612", null, new ZLColor(11599616), 11599616);
	}
	...
	public void test2a_5_06() {
		runTask2a("1232342351263423745612", new ZLColor(0), new ZLColor(11599616), 11599616);
	}
	
	public void test2a_5_07() {
		runTask2a("1232342351263423745612", new ZLColor(11599617), null, 11599617);
	}
	
	public void test2a_5_08() {
		runTask2a("1232342351263423745612", new ZLColor(11599618), new ZLColor(0), 0);
	}
	
	public void test2a_5_09() {
		runTask2a("1232342351263423745612", new ZLColor(11599619), new ZLColor(11599620), 11599620);
	}
	
	public void test2a_5_10() {
		runTask2a("1232342351263423745612", new ZLColor(11599619), new ZLColor(11599619), 11599619);
	}
	...
	public void test2a_6_09() {
		runTask2a("ерунда", new ZLColor(11599619), new ZLColor(11599620), 11599620);
	}
	
	public void test2a_6_10() {
		runTask2a("ерунда", new ZLColor(11599619), new ZLColor(11599619), 11599619);
	}
	...
	public void test2b_1_09() {
		runTask2b(null, new ZLColor(11599619), 
				new ZLColor(11599620), "11599620");
	}
	
	public void test2b_1_10() {
		runTask2b(null, new ZLColor(11599619), 
				new ZLColor(11599619), "def");
	}
	...
	public void test2b_3_09() {
		runTask2b("0", new ZLColor(11599619), 
				new ZLColor(11599620), "11599620");
	}
	...
	public void test2b_4_06() {
		runTask2b("12323412", new ZLColor(0), 
				new ZLColor(11599616), "11599616");
	}
	...
	public void test2b_4_09() {
		runTask2b("12323412", new ZLColor(11599619), 
				new ZLColor(11599620), "11599620");
	}
	...
	public void test2b_5_01() {
		runTask2b("1232342351263423745612", null, 
				null, "1232342351263423745612");
	}
	...
	public void test2b_5_04() {
		runTask2b("1232342351263423745612", new ZLColor(0), 
				null, "1232342351263423745612");
	}
	...
	public void test2b_5_07() {
		runTask2b("1232342351263423745612", new ZLColor(11599617), 
				null, "1232342351263423745612");
	}
	
	public void test2b_5_08() {
		runTask2b("1232342351263423745612", new ZLColor(11599618), 
				new ZLColor(0), "0");
	}
	
	public void test2b_5_09() {
		runTask2b("1232342351263423745612", new ZLColor(11599619), 
				new ZLColor(11599620), "11599620");
	}
	...
	public void test2b_6_09() {
		runTask2b("ерунда", new ZLColor(11599619), 
				new ZLColor(11599620), "11599620");
	}
