...
public class ConfigIOTests extends TestCase {
	...
	public void setUp() {
		...
		ZLConfigReaderFactory.createConfigReader("test/org/test/" +
				"zlibrary/options/examples/").read();
	}
	...
	public void test02() {
		ZLIntegerOption option = new ZLIntegerOption("options",
				"Options", "KeyDelay", 100);
	...
	public void test03() {
		ZLIntegerOption option = new ZLIntegerOption("options",
				"Options", "KeyDelay", 100);
		option.setValue(123);
		ZLConfigWriterFactory.createConfigWriter("test/org/test/" +
				"zlibrary/options/examples/output/").write();
	...
	public void test04() {
		ZLConfigReaderFactory.createConfigReader("test/org/test/" +
			"zlibrary/options/examples/output/").read();
		myConfig.unsetValue("Options", "KeyDelay");
		assertEquals(myConfig.getValue("Options", "KeyDelay", "meaningless"), "meaningless");
	}
...
//	тест на set несколько раз
	public void test05() {
		...
		assertEquals(myConfig.getValue("Options", "KeyDelay", "meaningless"), "VALUE2");
	}
