...
private:
	...
	void applySingleEntry(shared_ptr<ZLTextStyleEntry> entry, ZLTextStyleEntry::DisplayCode &code, unsigned char depth);
	void applyTagStyles(const std::string &tag, const std::string &aClass, ZLTextStyleEntry::DisplayCode &code, unsigned char depth);
