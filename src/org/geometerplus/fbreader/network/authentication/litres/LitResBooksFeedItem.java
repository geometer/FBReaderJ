...
public class LitResBooksFeedItem extends NetworkURLCatalogItem {
	public LitResBooksFeedItem(INetworkLink link, CharSequence title, CharSequence summary, UrlInfoCollection<?> urls) {
