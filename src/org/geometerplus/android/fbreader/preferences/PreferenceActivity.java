...
public class PreferenceActivity extends ZLPreferenceActivity {
	...
	protected void init() {
		...
		final Screen interactionScreen = optionsCategory.createPreferenceScreen("interaction");
		final Category interactionCategory = interactionScreen.createCategory(null);
